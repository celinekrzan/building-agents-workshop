...
```bash
git clone https://github.com/celinekrzan/clipify.git ~/.claude/skills/clipify
```
...
Adapted from [Louise de Sadeleer](https://github.com/louisedesadeleer), Growth at [Tella](https://tella.tv).
