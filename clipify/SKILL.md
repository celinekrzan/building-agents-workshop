---
name: clipify
description: Find the most impactful and shareable moments in a video, cut them as standalone clips, optionally reformat 16:9 → 9:16 (face-pan or split-screen), and burn opus-style word-by-word captions. Use when the user mentions "clipify," "cut clips from this video," "make shorts from this," "find impactful moments," "reframe to 9:16," "vertical clips," or pastes a video file path and wants social-ready cuts.
---

# Clipify

Find the most impactful and shareable moments in a video, cut them as standalone clips, optionally reformat 16:9 → 9:16 (face-pan or split-screen), and burn opus-style word-by-word captions.
...
### Step 1 — Find the most impactful and shareable moments
...
Read the resulting JSON (or `.txt`) and pick 3–5 candidate clips. Impact and shareability signals to scan for:

- **Strong declarative claims:** confident, opinionated statements that stand alone ("The reason X fails is...", "Most people get this wrong...")
- **Insight or reframe moments:** a shift in how something is described — contrarian takes, surprising analogies, "actually..." pivots
- **Quotable frameworks:** named models, numbered lists, memorable phrases that compress an idea ("It's not about X, it's about Y")
- **Emotional peaks:** voice rises in conviction, urgency, or vulnerability — not just volume, but presence
- **Call-to-action language:** words like "you need to", "stop doing", "the one thing", "if you only remember one thing"
- **Story payoffs:** the moment a story's lesson lands — short, self-contained, doesn't need the setup to hit
- **Audio energy:** detect via `ffmpeg -af volumedetect`; sustained high energy often signals key moments

For each candidate, propose: `[start, end, why-it's-impactful, suggested title]`. Aim for 15–45s clips (longer than comedy clips — context often matters for impact). Show the list and let the user confirm/pick.
