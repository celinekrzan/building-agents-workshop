...
Clipify needs a few local tools (ffmpeg, Whisper, Python). See [clipify/README.md](clipify/README.md) for setup.

## Use them as a starting point

Free to use as-is or to fork into your own. Start with one, run it on something real this week, then make it yours.

weekly-dashboard and fanout are mine. Clipify is adapted from [Louise de Sadeleer](https://github.com/louisedesadeleer) and keeps its own license and credit.
